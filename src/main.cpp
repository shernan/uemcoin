...
uint256 hashGenesisBlock("0x41e2929f2184e7688fdf6604a3e6217ff4304f0decaaeacb1d4bb46371fa1e5b");
...
{
    int64 nSubsidy = 15 * COIN; //15 Monedas de recompensa por bloque.

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // UEMCOIN: 1 dia para revisar dificultad.
static const int64 nTargetSpacing = 120; // UEMCOIN: Bloques cada 2 minutos.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal uemcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "UemCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf4f1228eab0798f45eadfbc93abdeba370a9fb7218ae60ade0c10b51ce9108d3");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Algeciras, PFG Criptomonedas 13/04/2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1399103531; //epochtime red principal
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3812432;

        if (fTestNet)
        {
            block.nTime    = 1399099131;
            block.nNonce   = 16385;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x39f728f1b4fd97f8afddd4300db3992524e5343b03f83b210c184694e9cde7c6"));
