...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "UemCoin - Debug window", 0, QApplication::UnicodeUTF8));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the UemCoin debug logfile from the current data directory. This can take a few seconds for large logfiles.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the uemcoin-qt help message to get a list with possible command-line options.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
