...
public:
    ...
    void retranslateUi(QWidget *AddressBookPage)
    {
        ...
        labelExplanation->setText(QApplication::translate("AddressBookPage", "These are your UemCoin addresses for receiving payments. You may want to give a different one to each sender so you can keep track of who is paying you.", 0, QApplication::UnicodeUTF8));
